 ...
 * @param bool   $expandedfilename whether or not the fullname of the RSS file should be used
 ...
 *
 * @param $errortype string Type of error to send, default is rsserror
