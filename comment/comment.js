            ...
            render: function(list, newcmt) {
                ...
                for(var i in list) {
                    ...
                    if (list[i]['delete']||newcmt) {
                        list[i].content = '<div class="comment-delete"><a href="#" id ="comment-delete-'+this.client_id+'-'+list[i].id+'" title="'+ Y.Escape.html(list[i].meaningfulid) +'"><img alt="'+ M.str.moodle.deletethiscomment +'" src="'+M.util.image_url('t/delete', 'core')+'" /></a></div>' + list[i].content;
                    }
