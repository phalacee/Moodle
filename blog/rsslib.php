 ...
 *
 * @deprecated Moodle 2.0. Please do not call this function any more. (Does not seem to be used anywhere)
 * @param stdClass $context The context of the blog for which the feed it being generated
 * @param array    $args    An array of arguements needed to build the feed (?, ?, ?, type, id, tagid)
 */
